...
export const Lockerbox =({ user, userID }) => {
  ...
  return (
    <div className='userbox'>
        ...
        <button className='button5' onClick={()=>setvisible(true)}>+ Add a new location</button>
        ...
        <form autoComplete="off" onSubmit={addlocation}>
            <label htmlFor="Location-name" className="addlocker-formtext">Location Name</label>
            <br/>
                <input type="text" className='addlocker-form-control' required
                    onChange={(e) => setName(e.target.value)} value={name} />
                <br /><br/>
                <label htmlFor="locker-count" className="addlocker-formtext">Number of lockers</label>
                <br/>
                <input type="number" className='addlocker-form-control' required
                    onChange={(e) => setCount(e.target.value)} value={count} />
                <br /><br/>
                <button type="submit" className='lockeraddbutton'>Add Location</button>
